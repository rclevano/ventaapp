...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ExceptionResponse> manejarTodasExcepciones(ModeloNotFountException ex, WebRequest request){
		ExceptionResponse er = new ExceptionResponse(LocalDateTime.now(), ex.getMessage(), request.getDescription(false));
		return new ResponseEntity<>(er, HttpStatus.INTERNAL_SERVER_ERROR);
	}
	
	@ExceptionHandler(ModeloNotFountException.class)
	public ResponseEntity<ExceptionResponse> manejarModeloNotFountException(ModeloNotFountException ex, WebRequest request){
		ExceptionResponse er = new ExceptionResponse(LocalDateTime.now(), ex.getMessage(), request.getDescription(false));
